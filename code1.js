gdjs.MainGameCode = {};
gdjs.MainGameCode.GDBottomArrowRoundButtonObjects4_1final = [];
...
gdjs.MainGameCode.GDLeftArrowRoundButtonObjects4_1final = [];

gdjs.MainGameCode.GDRightArrowRoundButtonObjects4_1final = [];
...
gdjs.MainGameCode.GDTopArrowRoundButtonObjects4_1final = [];
...
{for(var i = 0, len = gdjs.MainGameCode.GDLeftArrowRoundButtonObjects2.length ;i < len;++i) {
    gdjs.MainGameCode.GDLeftArrowRoundButtonObjects2[i].setX(gdjs.evtTools.window.getGameResolutionWidth(runtimeScene) * (224 / 800));
}
}{for(var i = 0, len = gdjs.MainGameCode.GDRightArrowRoundButtonObjects2.length ;i < len;++i) {
    gdjs.MainGameCode.GDRightArrowRoundButtonObjects2[i].setX(gdjs.evtTools.window.getGameResolutionWidth(runtimeScene) * (256 / 800));
}
}{for(var i = 0, len = gdjs.MainGameCode.GDTopArrowRoundButtonObjects2.length ;i < len;++i) {
    gdjs.MainGameCode.GDTopArrowRoundButtonObjects2[i].setX(gdjs.evtTools.window.getGameResolutionWidth(runtimeScene) * (480 / 800));
}
}{for(var i = 0, len = gdjs.MainGameCode.GDBottomArrowRoundButtonObjects2.length ;i < len;++i) {
    gdjs.MainGameCode.GDBottomArrowRoundButtonObjects2[i].setX(gdjs.evtTools.window.getGameResolutionWidth(runtimeScene) * (448 / 800));
}
}}
...
};gdjs.MainGameCode.mapOfGDgdjs_46MainGameCode_46GDLeftArrowRoundButtonObjects5Objects = Hashtable.newFrom({"LeftArrowRoundButton": gdjs.MainGameCode.GDLeftArrowRoundButtonObjects5});
gdjs.MainGameCode.mapOfGDgdjs_46MainGameCode_46GDTopArrowRoundButtonObjects5Objects = Hashtable.newFrom({"TopArrowRoundButton": gdjs.MainGameCode.GDTopArrowRoundButtonObjects5});
gdjs.MainGameCode.mapOfGDgdjs_46MainGameCode_46GDBottomArrowRoundButtonObjects5Objects = Hashtable.newFrom({"BottomArrowRoundButton": gdjs.MainGameCode.GDBottomArrowRoundButtonObjects5});
gdjs.MainGameCode.mapOfGDgdjs_46MainGameCode_46GDRightArrowRoundButtonObjects5Objects = Hashtable.newFrom({"RightArrowRoundButton": gdjs.MainGameCode.GDRightArrowRoundButtonObjects5});
...
{
{gdjs.MainGameCode.conditionTrue_1 = gdjs.MainGameCode.condition0IsTrue_0;
gdjs.MainGameCode.GDBottomArrowRoundButtonObjects4_1final.length = 0;gdjs.MainGameCode.GDLeftArrowRoundButtonObjects4_1final.length = 0;gdjs.MainGameCode.GDRightArrowRoundButtonObjects4_1final.length = 0;gdjs.MainGameCode.GDTopArrowRoundButtonObjects4_1final.length = 0;gdjs.MainGameCode.condition0IsTrue_1.val = false;
gdjs.MainGameCode.condition1IsTrue_1.val = false;
gdjs.MainGameCode.condition2IsTrue_1.val = false;
gdjs.MainGameCode.condition3IsTrue_1.val = false;
gdjs.MainGameCode.condition4IsTrue_1.val = false;
...
{
gdjs.copyArray(runtimeScene.getObjects("LeftArrowRoundButton"), gdjs.MainGameCode.GDLeftArrowRoundButtonObjects5);
gdjs.MainGameCode.condition2IsTrue_1.val = gdjs.evtTools.input.cursorOnObject(gdjs.MainGameCode.mapOfGDgdjs_46MainGameCode_46GDLeftArrowRoundButtonObjects5Objects, runtimeScene, true, false);
if( gdjs.MainGameCode.condition2IsTrue_1.val ) {
    gdjs.MainGameCode.conditionTrue_1.val = true;
    for(var j = 0, jLen = gdjs.MainGameCode.GDLeftArrowRoundButtonObjects5.length;j<jLen;++j) {
        if ( gdjs.MainGameCode.GDLeftArrowRoundButtonObjects4_1final.indexOf(gdjs.MainGameCode.GDLeftArrowRoundButtonObjects5[j]) === -1 )
            gdjs.MainGameCode.GDLeftArrowRoundButtonObjects4_1final.push(gdjs.MainGameCode.GDLeftArrowRoundButtonObjects5[j]);
    }
}
}
{
gdjs.copyArray(runtimeScene.getObjects("TopArrowRoundButton"), gdjs.MainGameCode.GDTopArrowRoundButtonObjects5);
gdjs.MainGameCode.condition3IsTrue_1.val = gdjs.evtTools.input.cursorOnObject(gdjs.MainGameCode.mapOfGDgdjs_46MainGameCode_46GDTopArrowRoundButtonObjects5Objects, runtimeScene, true, false);
if( gdjs.MainGameCode.condition3IsTrue_1.val ) {
    gdjs.MainGameCode.conditionTrue_1.val = true;
    for(var j = 0, jLen = gdjs.MainGameCode.GDTopArrowRoundButtonObjects5.length;j<jLen;++j) {
        if ( gdjs.MainGameCode.GDTopArrowRoundButtonObjects4_1final.indexOf(gdjs.MainGameCode.GDTopArrowRoundButtonObjects5[j]) === -1 )
            gdjs.MainGameCode.GDTopArrowRoundButtonObjects4_1final.push(gdjs.MainGameCode.GDTopArrowRoundButtonObjects5[j]);
    }
}
}
{
gdjs.copyArray(runtimeScene.getObjects("BottomArrowRoundButton"), gdjs.MainGameCode.GDBottomArrowRoundButtonObjects5);
gdjs.MainGameCode.condition4IsTrue_1.val = gdjs.evtTools.input.cursorOnObject(gdjs.MainGameCode.mapOfGDgdjs_46MainGameCode_46GDBottomArrowRoundButtonObjects5Objects, runtimeScene, true, false);
if( gdjs.MainGameCode.condition4IsTrue_1.val ) {
    gdjs.MainGameCode.conditionTrue_1.val = true;
    for(var j = 0, jLen = gdjs.MainGameCode.GDBottomArrowRoundButtonObjects5.length;j<jLen;++j) {
        if ( gdjs.MainGameCode.GDBottomArrowRoundButtonObjects4_1final.indexOf(gdjs.MainGameCode.GDBottomArrowRoundButtonObjects5[j]) === -1 )
            gdjs.MainGameCode.GDBottomArrowRoundButtonObjects4_1final.push(gdjs.MainGameCode.GDBottomArrowRoundButtonObjects5[j]);
    }
}
}
{
gdjs.copyArray(runtimeScene.getObjects("RightArrowRoundButton"), gdjs.MainGameCode.GDRightArrowRoundButtonObjects5);
gdjs.MainGameCode.condition5IsTrue_1.val = gdjs.evtTools.input.cursorOnObject(gdjs.MainGameCode.mapOfGDgdjs_46MainGameCode_46GDRightArrowRoundButtonObjects5Objects, runtimeScene, true, false);
if( gdjs.MainGameCode.condition5IsTrue_1.val ) {
    gdjs.MainGameCode.conditionTrue_1.val = true;
    for(var j = 0, jLen = gdjs.MainGameCode.GDRightArrowRoundButtonObjects5.length;j<jLen;++j) {
        if ( gdjs.MainGameCode.GDRightArrowRoundButtonObjects4_1final.indexOf(gdjs.MainGameCode.GDRightArrowRoundButtonObjects5[j]) === -1 )
            gdjs.MainGameCode.GDRightArrowRoundButtonObjects4_1final.push(gdjs.MainGameCode.GDRightArrowRoundButtonObjects5[j]);
    }
}
}
{
gdjs.copyArray(gdjs.MainGameCode.GDBottomArrowRoundButtonObjects4_1final, gdjs.MainGameCode.GDBottomArrowRoundButtonObjects4);
gdjs.copyArray(gdjs.MainGameCode.GDLeftArrowRoundButtonObjects4_1final, gdjs.MainGameCode.GDLeftArrowRoundButtonObjects4);
gdjs.copyArray(gdjs.MainGameCode.GDRightArrowRoundButtonObjects4_1final, gdjs.MainGameCode.GDRightArrowRoundButtonObjects4);
gdjs.copyArray(gdjs.MainGameCode.GDTopArrowRoundButtonObjects4_1final, gdjs.MainGameCode.GDTopArrowRoundButtonObjects4);
}
}
}if (gdjs.MainGameCode.condition0IsTrue_0.val) {
